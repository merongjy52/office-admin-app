...
if main_menu == "근무제도" and sub_menu == "근무일과 휴일":
    ...
    st.divider()
    st.info("다음 단계에서는 근무시간과 휴게시간 화면을 이어서 붙이면 됩니다.")
    ...
    st.divider()
    st.info("다음 단계에서는 휴일대체근무제도 화면을 같은 형식으로 이어서 붙이면 됩니다.")
    ...
    st.divider()
    st.info("다음 단계에서는 근무형태 변경시 처리 화면을 같은 형식으로 이어서 붙이면 됩니다.")
    ...
    st.divider()
    st.info("다음 단계에서는 지정휴무 화면까지 확인한 뒤 휴가제도 화면으로 이어서 만들면 됩니다.")
    ...
    st.divider()
    st.success("근무제도 메뉴는 현재 기준으로 근무일과 휴일부터 지정휴무까지 모두 구현되었습니다.")
    st.info("다음 단계에서는 휴가제도 화면을 같은 구조로 이어서 만들면 됩니다.")
